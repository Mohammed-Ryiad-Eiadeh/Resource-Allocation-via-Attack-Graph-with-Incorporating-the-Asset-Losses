...
public class PageRankWithInDegreeMain {
    public static void main(String[] args) {
        ...
        var task = new GraphData(Graph.VOIP_rand);
        ...
        var iterator = scores.entrySet().iterator();
        System.out.println();
        // Show the node ID with its rank score gently
        if (iterator.hasNext()) {
            do {
                var current = iterator.next();
                System.out.println("The rank score of " + current.getKey() + " is : " + current.getValue());
